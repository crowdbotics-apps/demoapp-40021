"""
Django settings for demoapp_40021 project.
...
ROOT_URLCONF = 'demoapp_40021.urls'
...
WSGI_APPLICATION = 'demoapp_40021.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp_40021 API",
    "DESCRIPTION": "API documentation for demoapp_40021 App",
    "VERSION": "v1",
}
